...
import 'package:hubx/src/shared/stream_logger.dart';
...
mixin EventTransformerMixin<E extends BaseBlocEvent, S extends BaseBlocState>
  ...
  /// Only emit events from the source sequence whenever the time span
  /// defined by [duration] passes, without the source sequence
