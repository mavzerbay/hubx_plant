...
class _UserClient implements UserClient {
  ...
  @override
  Future<BaseResponseModel<UserResponseModel>> login(LoginRequest body) async {
  ...
  @override
  Future<BaseResponseModel<UserResponseModel>> profile() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<BaseResponseModel<UploadPhotoResponseModel>> uploadPhoto(
    ...
    final _options =
        _setStreamType<BaseResponseModel<UploadPhotoResponseModel>>(
          Options(
                method: 'POST',
                headers: _headers,
                extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponseModel<UploadPhotoResponseModel> _value;
    try {
      _value = BaseResponseModel<UploadPhotoResponseModel>.fromJson(
        _result.data!,
        (json) =>
